...
pub fn parse_markdown(sack: &Sack<Data>, content: &str) -> String {
    ...
    let parser = Parser::new_ext(content, markdown_opts);
    ...
    clean(&output_str_buf)
}

pub fn format_html_with_meta<Metadata>(
